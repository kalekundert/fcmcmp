# -*- coding: utf-8 -*-
#
# FACS Helper documentation build configuration file, created by
...
version = facs_helper.__version__
# The full version, including alpha/beta/rc tags.
release = facs_helper.__version__
...
man_pages = [
    ('index', 'cookiecutterproject_name', u'FACS Helper Documentation',
     [u'Kale Kundert'], 1)
]
